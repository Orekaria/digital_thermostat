...
#define SPEED_FULL 0X00 // full processor speed (0x00) = 16Mhz. Formula: time * pow(2, (uint8_t)SPEED_)
#define SPEED_REDUCED 0X01 // 0x01 = 16/2 = 8Mhz, 0x02 = 16/4 = 4 Mhz, 0x03 = 16/8 = 2 Mhz
